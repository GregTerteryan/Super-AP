...
public class Word{
    ...
    public Word(String startWord) {
        ...
        for (int c = 0; c < chars.length; c++) {
            ...
            if (c > 0) {
                lines.get(line).get(lines.get(line).size() - 1).translate(lines.get(line).get(lines.get(line).size() - 2).getMaxX() + gap, lines.get(line).get(lines.get(line).size() - 2).getY());
                if (lines.get(line).get(lines.get(line).size() - 1).getMaxX() > 1280) {
		            ...
		            lines.get(line).get(1).translate(lines.get(line).get(0).getX() - lines.get(line).get(1).getX() + lines.get(line).get(0).getMaxX() + gap, 43);
                }
            }
        }
    }
